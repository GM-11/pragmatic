  ...
  if (loading) {
    return (
      <View className="flex-1 items-center justify-center bg-rose-50 rounded-3xl mx-2 shadow-inner">
        ...
        <Text className="text-gray-500 text-center mt-2 text-xs px-8">
  ...
  if (!imageUrl) {
    return (
      <View className="flex-1 items-center justify-center bg-gradient-to-b from-rose-50 to-white rounded-3xl mx-2 p-6 shadow-inner">
        ...
        <Text className="text-2xl font-medium text-gray-700 text-center mb-4">
          Imagine Your Perfect Wallpaper
        </Text>
        <Text className="text-gray-500 text-center mb-2 leading-relaxed px-4">
        ...
        <View className="flex-row items-center justify-center flex-wrap">
          <TouchableOpacity className="bg-white/80 m-1 px-3 py-1 rounded-full shadow-sm">
            <Text className="text-xs text-rose-600">Sunset beach</Text>
          </TouchableOpacity>
          <TouchableOpacity className="bg-white/80 m-1 px-3 py-1 rounded-full shadow-sm">
            <Text className="text-xs text-rose-600">Mountain landscape</Text>
          </TouchableOpacity>
          <TouchableOpacity className="bg-white/80 m-1 px-3 py-1 rounded-full shadow-sm">
            <Text className="text-xs text-rose-600">Abstract art</Text>
          </TouchableOpacity>
          <TouchableOpacity className="bg-white/80 m-1 px-3 py-1 rounded-full shadow-sm">
            <Text className="text-xs text-rose-600">Minimalist</Text>
          </TouchableOpacity>
        </View>
      </View>
    );
